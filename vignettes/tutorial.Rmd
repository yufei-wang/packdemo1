...
```
Based on the plot, the line looks like only fit the data points of Europe and Oceania. The linear relationships indicates that the model is good for Europe and Oceania. However, for other continents, the model doesn't work properly. Thus, we should try other regressions to fit.
